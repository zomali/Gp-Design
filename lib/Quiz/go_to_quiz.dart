...
class go_to_quiz extends StatefulWidget {
  ...
  go_to_quiz(this.std, this.ID, this.Q_type, this.weakness_topics);
  @override
  State<StatefulWidget> createState() => _go_to_quiz(std, ID, Q_type, weakness_topics);
}
...
class _go_to_quiz extends State<go_to_quiz> {
  ...
  _go_to_quiz(this.std, this.ID, this.Q_type, this.weakness_topics );
        ...
        return BlocBuilder<QuestionCubit, QuestionState>(
          builder: (context, state) {
            if(state is QuestionLoading)
            {
              ...
              return Start_Quiz(std, ID,Q_type,weakness_topics, questions);
            }
          }
        );
      }
